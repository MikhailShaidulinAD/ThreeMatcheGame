...
void ATile::OnMatched_Implementation(EThreeMatchMoveType::Type MoveType)
{
...
void ATile::StartFalling(bool bUseCurrentWorldLocation)
{
	...
	AThreeMatchGameMode* CurrentGameMode = Cast<AThreeMatchGameMode>(UGameplayStatics::GetGameMode(this));
