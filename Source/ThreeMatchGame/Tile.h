...
*/
UCLASS()
class THREEMATCHGAME_API ATile : public APaperSpriteActor
{
	GENERATED_BODY()
...
public:
	...
	UFUNCTION(BlueprintNativeEvent, Category = "Special Game Events")
	void OnMatched(EThreeMatchMoveType::Type MoveType);
	virtual void OnMatched_Implementation(EThreeMatchMoveType::Type MoveType);
